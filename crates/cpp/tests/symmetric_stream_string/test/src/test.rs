  ...
  pub mod a {
    pub mod b {
      ...
      pub trait Guest {
        ...
        fn f() -> wit_bindgen::rt::async_support::StreamReader<_rt::String>;
      }
      #[doc(hidden)]
...
#[cfg(target_arch = "wasm32")]
#[unsafe(link_section = "component-type:wit-bindgen:0.44.0:a:b:test:encoded world")]
#[doc(hidden)]
...
B\x03\x01f\x01s\x01@\0\0\0\x04\0\x01f\x01\x01\x04\0\x0ca:b/the-test\x05\0\x04\0\x08\
a:b/test\x04\0\x0b\x0a\x01\0\x04test\x03\0\0\0G\x09producers\x01\x0cprocessed-by\
\x02\x0dwit-component\x070.237.0\x10wit-bindgen-rust\x060.44.0";
