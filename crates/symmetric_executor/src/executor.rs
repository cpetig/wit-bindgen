    ...
    pub mod symmetric {
        pub mod runtime {
            ...
            pub mod symmetric_executor {
                ...
                #[doc(hidden)]
                macro_rules! __export_symmetric_runtime_symmetric_executor_0_3_0_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BmethodX5Devent_subscriptionX2Eready(arg0
                        ...
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BstaticX5Devent_subscriptionX2Efrom_timeout(arg0
                        ...
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BmethodX5Devent_subscriptionX2Edup(arg0
                        ...
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BmethodX5Devent_subscriptionX2Ereset(arg0
                        ...
                        "C" fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BmethodX5Devent_generatorX2Esubscribe(arg0
                        : * mut u8,) -> * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BmethodX5Devent_generatorX2Eactivate(arg0
                        : * mut u8,) { unsafe { $($path_to_types)*::
                        ...
                        #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
                        #[allow(non_snake_case)] unsafe extern "C" fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5BstaticX5Dcallback_registrationX2Ecancel(arg0
                        : * mut u8,) -> * mut u8 { unsafe { $($path_to_types)*::
                        ...
                        #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
                        #[allow(non_snake_case)] unsafe extern "C" fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00register(arg0
                        ...
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00block_on(arg0
                        : * mut u8,) { unsafe { $($path_to_types)*::
                        _export_block_on_cabi::<$ty > (arg0) } }
                        #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
                        #[allow(non_snake_case)] unsafe extern "C" fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5Bresource_dropX5Dcallback_function(arg0
                        : usize) { $($path_to_types)*::
                        _export_drop_callbackFunction_cabi::<<$ty as $($path_to_types)*::
                        Guest >::CallbackFunction > (arg0) } #[cfg_attr(not(target_arch =
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5Bresource_dropX5Dcallback_data(arg0
                        : usize) { $($path_to_types)*::
                        _export_drop_callbackData_cabi::<<$ty as $($path_to_types)*::
                        Guest >::CallbackData > (arg0) } #[cfg_attr(not(target_arch =
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5Bresource_dropX5Devent_subscription(arg0
                        : usize) { $($path_to_types)*::
                        _export_drop_eventSubscription_cabi::<<$ty as
                        $($path_to_types)*:: Guest >::EventSubscription > (arg0) }
                        #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
                        #[allow(non_snake_case)] unsafe extern "C" fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5Bresource_dropX5Devent_generator(arg0
                        : usize) { $($path_to_types)*::
                        _export_drop_eventGenerator_cabi::<<$ty as $($path_to_types)*::
                        Guest >::EventGenerator > (arg0) } #[cfg_attr(not(target_arch =
                        "wasm32"), no_mangle)] #[allow(non_snake_case)] unsafe extern "C"
                        fn
                        symmetricX3AruntimeX2Fsymmetric_executorX400X2E3X2E0X00X5Bresource_dropX5Dcallback_registration(arg0
                        : usize) { $($path_to_types)*::
                ...
                #[doc(hidden)]
                pub(crate) use __export_symmetric_runtime_symmetric_executor_0_3_0_cabi;
            }
        }
    }
}
...
macro_rules! __export_executor_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*::
        exports::symmetric::runtime::symmetric_executor::__export_symmetric_runtime_symmetric_executor_0_3_0_cabi!($ty
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.47.0:symmetric:runtime@0.3.0:executor:encoded world"
)]
#[doc(hidden)]
...
\x01\x1a\x04\0*symmetric:runtime/symmetric-executor@0.3.0\x05\0\x04\0\x20symmetr\
ic:runtime/executor@0.3.0\x04\0\x0b\x0e\x01\0\x08executor\x03\0\0\0G\x09producer\
s\x01\x0cprocessed-by\x02\x0dwit-component\x070.240.0\x10wit-bindgen-rust\x060.4\
7.0";
#[inline(never)]
#[doc(hidden)]
