...
pub mod exports {
    ...
    pub mod foo {
        ...
        pub mod foo {
            ...
            pub mod resources {
                    ...
                    unsafe fn drop(_handle: u32) {
                        {
                            ...
                            crate::b_impl::X5BexportX5DfooX3AfooX2FresourcesX00X5Bresource_dropX5Dr(
                                _handle,
                            );
                        }
                    }
                ...
                pub unsafe fn _export_constructor_r_cabi<T: GuestR + Debug>(arg0: i32) -> i32 {
                    #[cfg(target_arch = "wasm32")]
                    _rt::run_ctors_once();
                ...
                pub trait GuestR: 'static {
                        ...
                        Self: Sized,
                    {
                        ...
                        crate::b_impl::X5BexportX5DfooX3AfooX2FresourcesX00X5Bresource_newX5Dr(val)
                    }
                        ...
                        Self: Sized,
                    {
                        ...
                        crate::b_impl::X5BexportX5DfooX3AfooX2FresourcesX00X5Bresource_repX5Dr(
                            handle as i32,
                        )
                    }
  ...
  ($ty:ident with_types_in $($path_to_types:tt)*) => {
    ...
    pub unsafe extern "C" fn fooX3AfooX2FresourcesX23X5BconstructorX5Dr(arg0: i32,) -> i32 {
    ...
    #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
    pub unsafe extern "C" fn fooX3AfooX2FresourcesX23X5BmethodX5DrX2Eadd(arg0: *mut u8,arg1: i32,) {
    ...
    #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
    pub unsafe extern "C" fn fooX3AfooX2FresourcesX23create() -> i32 {
      $($path_to_types)*::_export_create_cabi::<$ty>()
    }
    #[cfg_attr(target_arch = "wasm32", export_name = "foo:foo/resources#consume")]
    #[cfg_attr(not(target_arch = "wasm32"), no_mangle)]
    pub unsafe extern "C" fn fooX3AfooX2FresourcesX23consume(arg0: i32,) {
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.26.0:b:encoded world"]
#[doc(hidden)]
...
0.209.0\x10wit-bindgen-rust\x060.26.0";
