...
#ifndef __CPP_GUEST_BINDINGS_EXECUTOR_IMPORT_H
#define __CPP_GUEST_BINDINGS_EXECUTOR_IMPORT_H
...
std::optional<CallbackRegistration> RegisterUnique(EventSubscription &&trigger,
