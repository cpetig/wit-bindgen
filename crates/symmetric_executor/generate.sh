...
(cd rust-client/src;../../../../target/debug/wit-bindgen rust ../../wit -w stream-import --symmetric --format --link-name symmetric_stream --with symmetric:runtime/symmetric-executor@0.3.0=crate::symmetric_executor ; cd .. ; cargo fmt)
