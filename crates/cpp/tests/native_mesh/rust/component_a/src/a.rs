        ...
        pub mod resources {
                ...
                unsafe fn drop(_handle: u32) {
                    {
                        ...
                        crate::a_impl::fooX3AfooX2FresourcesX00X5Bresource_dropX5Dr(_handle);
                    }
                }
            }
            ...
            impl R {
                ...
                pub fn new(a: u32) -> Self {
                    unsafe {
                        ...
                        let ret = crate::a_impl::fooX3AfooX2FresourcesX00X5BconstructorX5Dr(
                            _rt::as_i32(&a),
                        );
            ...
            impl R {
                ...
                pub fn add(&self, b: u32) {
                    unsafe {
                        ...
                        crate::a_impl::fooX3AfooX2FresourcesX00X5BmethodX5DrX2Eadd(
                            (self).handle() as i32,
                            _rt::as_i32(&b),
                        );
                    }
            ...
            pub fn create() -> R {
                unsafe {
                    ...
                    let ret = crate::a_impl::fooX3AfooX2FresourcesX00create();
                    R::from_handle(ret as u32)
                }
            }
            #[allow(unused_unsafe, clippy::all)]
            ...
            pub fn consume(o: R) {
                unsafe {
                    ...
                    crate::a_impl::fooX3AfooX2FresourcesX00consume((&o).take_handle());
                }
            }
        }
    }
...
#[cfg(target_arch = "wasm32")]
#[link_section = "component-type:wit-bindgen:0.26.0:a:encoded world"]
#[doc(hidden)]
