                ...
                pub fn close_read(&self) -> _rt::Vec<Buffer> {
                    unsafe {
                        ...
                        unsafe extern "C" {
                            ...
                            fn symmetricX3AruntimeX2Fsymmetric_streamX400X2E2X2E1X00X5BmethodX5Dstream_objX2Eclose_read(
                                _: *mut u8,
                                _: *mut u8,
                            );
                        }
                        symmetricX3AruntimeX2Fsymmetric_streamX400X2E2X2E1X00X5BmethodX5Dstream_objX2Eclose_read(
                            (self).handle() as *mut u8,
                            ptr0,
                        );
...
#[unsafe(
    link_section = "component-type:wit-bindgen:0.44.0:symmetric:runtime@0.2.1:module:encoded world"
)]
#[doc(hidden)]
...
-obj.read-ready-activate\x01\x12\x03\0(symmetric:runtime/symmetric-stream@0.2.1\x05\
\x02\x04\0\x1esymmetric:runtime/module@0.2.1\x04\0\x0b\x0c\x01\0\x06module\x03\0\
\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-component\x070.237.0\x10wit-bi\
ndgen-rust\x060.44.0";
#[inline(never)]
#[doc(hidden)]
