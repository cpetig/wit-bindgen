...
pub mod a {
  pub mod b {
    ...
    pub mod the_test {
      ...
      pub fn f() -> wit_bindgen::rt::async_support::StreamReader<_rt::String>{
        unsafe {
          ...
          wit_bindgen::rt::async_support::StreamReader::new(ret, &super::super::super::wit_stream::vtable0::VTABLE)
        }
      }
...
pub mod wit_stream {
  ...
  pub mod vtable0 {
    ...
    unsafe fn lower(value: super::super::_rt::String, ptr: *mut u8) { unsafe { let vec0 = value;
...
pub static VTABLE: wit_bindgen::rt::async_support::StreamVtable<super::super::_rt::String> = wit_bindgen::rt::async_support::StreamVtable::<super::super::_rt::String> {
  
  
  layout: unsafe {
    ::std::alloc::Layout::from_size_align_unchecked(2*::core::mem::size_of::<*const u8>(), ::core::mem::size_of::<*const u8>())
  },
  lift: Some(lift),
  lower: Some(lower),
...
#[unsafe(link_section = "component-type:wit-bindgen:0.44.0:a:b:runner:encoded world")]
#[doc(hidden)]
...
d-by\x02\x0dwit-component\x070.237.0\x10wit-bindgen-rust\x060.44.0";
