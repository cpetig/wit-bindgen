    ...
    pub mod test {
        ...
        pub mod wait {
            ...
            pub async fn sleep(nanoseconds: u64) -> () {
                unsafe {
                    #[cfg_attr(not(target_arch = "wasm32"), link(name = "sleep"))]
    ...
    pub mod test {
        pub mod test {
            ...
            pub mod string_delay {
                ...
                pub unsafe fn _export_forward_cabi<T_: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                    arg2: *mut u8,
                ) -> *mut u8 {
...
#[cfg(target_arch = "wasm32")]
#[unsafe(
    link_section = "component-type:wit-bindgen:0.53.1:test:test:async-module:encoded world"
)]
#[doc(hidden)]
...
A\x04\x01B\x02\x01C\x01\x0bnanosecondsw\x01\0\x04\0\x05sleep\x01\0\x03\0\x0etest\
:test/wait\x05\0\x01B\x02\x01C\x01\x01ss\0s\x04\0\x07forward\x01\0\x04\0\x16test\
...
0.245.0\x10wit-bindgen-rust\x060.53.1";
#[inline(never)]
#[doc(hidden)]
